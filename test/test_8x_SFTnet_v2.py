...
LR_dep_art=Image.open("/media/yifan/Data/test_data/noise_free/middlebury_bicubic_LR_test_pairs/"+data_name+"/"+data_name+"8x_bicubic.png")#####for noise-free midd2006
#LR_dep_art=Image.open("/media/yifan/Data/test_data/noisy/table2/_input/"+data_name+"_big/depth_3_n.png")###mid 2006
#LR_dep_art=Image.open("/media/yifan/Data/test_data/noisy/iccv15_test_imgs/input/"+data_name+"/8_x_dep.png")###mid 2001
...
with tf.Session() as sess:
    model_path="/media/yifan/Data/trained_models/sft_depup_net/noise_free/l1loss/8x/best_model/full_model3/8x_nf_cgsft_model.ckpt-119"
    ...
    #result_img.show()
    result_img.save("/media/yifan/Data/trained_models/sft_depup_net/noise_free/l1loss/8x/best_model/result/"+data_name+"8x_result.png")
    ######################computing rmse
