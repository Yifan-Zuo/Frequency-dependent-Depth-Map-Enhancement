...
LR_dep_art=Image.open("/media/yifan/Data/test_data/noise_free/middlebury_bicubic_LR_test_pairs/"+data_name+"/"+data_name+"4x_bicubic.png")#####for noise-free midd2006
#LR_dep_art=Image.open("/media/yifan/Data/test_data/noisy/table2/_input/"+data_name+"_big/depth_2_n.png")###mid 2006
#LR_dep_art=Image.open("/media/yifan/Data/test_data/noisy/iccv15_test_imgs/input/"+data_name+"/4_x_dep.png")###mid 2001
...
inten_feat_down=sbb.inten_FDown(inten_feat,2,1)
...
with tf.Session() as sess:
    model_path="/media/yifan/Data/trained_models/sft_depup_net/noise_free/l1loss/4x/full_model/4x_nf_cgsft_model.ckpt-22"
    ...
    #result_img.show()
    result_img.save("/media/yifan/Data/trained_models/sft_depup_net/noise_free/l1loss/4x/results/"+data_name+"4x_result.png")
    ######################computing rmse
