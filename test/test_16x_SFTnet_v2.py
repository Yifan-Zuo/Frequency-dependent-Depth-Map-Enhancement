...
with tf.Session() as sess:
    model_path="/media/yifan/Data/trained_models/sft_depup_net/noise_free/l1loss/16x/full_model3/16x_nf_cgsft_model.ckpt-77"
    ...
    #result_img.show()
    result_img.save("/media/yifan/Data/trained_models/sft_depup_net/noise_free/l1loss/16x/result/"+data_name+"16x_result.png")
    ######################computing rmse
